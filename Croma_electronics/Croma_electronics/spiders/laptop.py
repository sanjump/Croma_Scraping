...
class CromaSpider(scrapy.Spider):
    ...
    start_urls=['https://www.croma.com/computers-tablets/laptops/c/20']
    ...
    def parse(self, response):
        ...
        page = 'https://www.croma.com/computers-tablets/laptops/c/20?q=%3Arelevance%3AskuStockFlag%3Atrue&page='+ str(CromaSpider.pageno)
