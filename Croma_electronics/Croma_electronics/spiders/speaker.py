...
class CromaSpider(scrapy.Spider):
    ...
    start_urls=['https://www.croma.com/audio-video/speakers/c/1006']
    ...
    def parse(self, response):
        ...
        page = 'https://www.croma.com/audio-video/speakers/c/1006?q=%3Arelevance%3AskuStockFlag%3Atrue&page='+ str(CromaSpider.pageno)
        if CromaSpider.pageno <=4:
