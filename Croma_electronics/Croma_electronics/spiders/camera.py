...
class CromaSpider(scrapy.Spider):
    ...
    start_urls=['https://www.croma.com/cameras/professional-cameras/c/548']
    ...
    def parse(self, response):
        ...
        page = 'https://www.croma.com/cameras/professional-cameras/c/548?q=%3Arelevance%3AskuStockFlag%3Atrue&page='+ str(CromaSpider.pageno)
