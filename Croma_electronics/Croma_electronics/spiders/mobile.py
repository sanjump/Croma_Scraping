...
class CromaSpider(scrapy.Spider):
    ...
    start_urls=['https://www.croma.com/phones-wearables/mobile-phones/c/10']
    ...
    def parse(self, response):
        ...
        page = 'https://www.croma.com/phones-wearables/mobile-phones/c/10?q=%3Arelevance%3AskuStockFlag%3Atrue&page='+ str(CromaSpider.pageno)
